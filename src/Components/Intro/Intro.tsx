...
const Intro: FC = () => {
  ...
  useEffect(() => {
    if (
      ...
      lampLegRef.current &&
      lampbtRef.current &&
      lampLineBRef.current &&
      lampCircleRef.current &&
      lampLineTRef.current &&
      lampHeadRef.current &&
      lampHeaderRef.current &&
      lampBodyRef.current &&
      computerRef.current &&
      keyboardRef.current &&
      ...
      tl.from(bgdRef.current, {
        ...
        .staggerFrom(
          [tableRef.current, lampLegRef.current],
          0.2,
          { y: "-=200", opacity: 0, ease: "elastic.out" },
          0.1
        )
        .from(lampbtRef.current, {
          opacity: 0,
          scale: 0,
          transformOrigin: "center center",
          duration: 0.2,
        })
        .from(lampLineBRef.current, {
          opacity: 0,
          transformOrigin: "100% 100%",
          rotation: "-180deg",
          duration: 0.3,
        })
        .from(lampCircleRef.current, {
          opacity: 0,
          x: "-=100",
          y: "-=100",
          duration: 0.1,
        })
        .from(lampLineTRef.current, {
          opacity: 0,
          transformOrigin: "0% 100%",
          rotation: "-180deg",
          duration: 0.3,
        })
        .from(lampHeadRef.current, {
          opacity: 0,
          scale: 0,
          ease: "elastic.out",
          duration: 0.2,
        })
        .from(lampHeaderRef.current, {
          transformOrigin: "60% 60%",
          rotation: "60deg",
          duration: 0.5,
        })
        .from(lampBodyRef.current, {
        ...
        .to(lampLightRef.current, { opacity: 0, duration: 0.1 }, "+=0.2")
        .to(lampLightRef.current, { opacity: 0.2, duration: 0.1 })
        .to(bgdRef.current, { opacity: 0.1, duration: 0.2, delay: 0.5 })
        .to(bgdRef.current, { opacity: 1, duration: 0.1 }, "+=0.1")
        .to(bgdRef.current, { opacity: 0.5, duration: 0.1 }, "+=0.1")
        .to(bgdRef.current, {
          opacity: 1,
          fill: "rgb(255 240 0)",
          duration: 0.2,
        ...
        .fromTo(
          lampLineRef.current,
          { opacity: 0 },
          { opacity: 0.2, duration: 0.2, delay: 0.5 },
          "+=0.05"
        )
        ...
        .to(screenRef.current, { opacity: 1, fill: "#F8F8F8", duration: 0.2 });
    }
  }, []);
